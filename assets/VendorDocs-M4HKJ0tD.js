import{u as h,as as x,r as m,j as e,at as n,L as i,au as u}from"./index-C5lbkaVi.js";import{V as g}from"./VendorShell-DdAkFnmo.js";function s({children:t}){return e.jsx("pre",{className:"bg-earth-900 text-earth-100 text-xs rounded-lg p-3 whitespace-pre-wrap break-words my-2",children:e.jsx("code",{children:t})})}const y=`<script src="${n}/v1/widget.js"
...
}`,w='{ "orderId": "SHOP-10432", "checkoutUrl": "https://your-shop.example/checkout/…" }',j=`<script src="${n}/v1/widget.js"
        data-key="pk_live_YOUR_KEY"
        data-app="https://poolbuyr.com"
        async><\/script>
<script src="${n}/v1/shopify.js" async><\/script>`,d=`<header class="shop-head">
...
render();`,c=`body { font-family: system-ui, sans-serif; margin: 0 auto; padding: 20px 16px 40px; max-width: 560px; color: #1f2937; }
...
[data-poolbuyr-widget] { box-sizing: border-box; max-width: 100% !important; padding: 12px; border: 2px solid #10b981; border-radius: 16px; background: #ecfdf5; }`,v=`<style>
${c.split(`
`).map(t=>"  "+t).join(`
`)}
</style>
