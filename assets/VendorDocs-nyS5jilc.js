import{u as x,as as p,r as h,j as e,at as r,L as a}from"./index-DbcntEFp.js";import{V as u}from"./VendorShell-mTSMvGUr.js";function s({children:t}){return e.jsx("pre",{className:"bg-earth-900 text-earth-100 text-xs rounded-lg p-3 whitespace-pre-wrap break-words my-2",children:e.jsx("code",{children:t})})}const b=`<script src="${r}/v1/widget.js"
        data-key="pk_live_YOUR_KEY"
        data-app="https://poolbuyr.com"
        async><\/script>`,y=`// Your site: build the pooled basket with your own cart code.
...
}`,j='{ "orderId": "SHOP-10432", "checkoutUrl": "https://your-shop.example/checkout/…" }',f=`<script src="${r}/v1/widget.js"
        data-key="pk_live_YOUR_KEY"
        data-app="https://poolbuyr.com"
        async><\/script>
...
<script src="${r}/v1/widget.js"
        ...
        data-demo="1"
        data-postal="1012"
        async><\/script>`,c=`// Stands in for your cart code: run this whenever the cart changes, with the
// product ids your platform actually uses.
document.getElementById('add').addEventListener('click', function () {
  window.PoolbuyrWidget.setCart([
    { productId: '1001', variantId: '1001-0', title: 'Wool throw, undyed', unitPrice: 89.00, quantity: 1 },
  ]);
});`,l=`body { font-family: system-ui, sans-serif; padding: 16px; max-width: 480px; }
button { padding: 8px 14px; border: 0; border-radius: 8px; background: #4f46e5; color: #fff; font-weight: 600; cursor: pointer; }`,N=`<style>
${l.split(`
`).map(t=>"  "+t).join(`
`)}
</style>
