import{u as l,as as c,r as m,j as e,L as n,at as d}from"./index-DFFW5XSR.js";import{V as x}from"./VendorShell-ChAiTFEh.js";import{C as h}from"./CodePenButton-Cdh4Ma-I.js";function t({children:s}){return e.jsx("pre",{className:"bg-earth-900 text-earth-100 text-xs rounded-lg p-3 whitespace-pre-wrap break-words my-2",children:e.jsx("code",{children:s})})}const p=`<script src="${d}/v1/widget.js"
