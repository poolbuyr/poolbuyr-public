import{u as i,j as e,as as d,L as c}from"./index-BPFj21tC.js";import{V as l}from"./VendorShell-04tEYKEu.js";function s({children:t}){return e.jsx("pre",{className:"bg-earth-900 text-earth-100 text-xs rounded-lg p-3 overflow-x-auto my-2",children:e.jsx("code",{children:t})})}const m=`<script src="${d}/v1/widget.js"
...
}`,p='{ "orderId": "SHOP-10432", "checkoutUrl": "https://your-shop.example/checkout/…" }',r=`<h1>My shop</h1>
...
<script src="${d}/v1/widget.js"
        ...
        data-demo="1"
        data-postal="1012"
        async><\/script>`,u=`// Stands in for your cart code: run this whenever the cart changes, with the
