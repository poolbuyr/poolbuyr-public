import{u as a,j as e,as as n,L as i}from"./index-6M9WoUtS.js";import{V as l}from"./VendorShell-CCAmjwfJ.js";function t({children:s}){return e.jsx("pre",{className:"bg-earth-900 text-earth-100 text-xs rounded-lg p-3 overflow-x-auto my-2",children:e.jsx("code",{children:s})})}const c=`<script src="${n}/v1/widget.js"
