import{u as l,as as c,r as m,j as e,L as n,at as d}from"./index-DngFWQ5s.js";import{V as x}from"./VendorShell-CpXGXGvz.js";import{C as h}from"./CodePenButton-BZ2E5LgC.js";function t({children:s}){return e.jsx("pre",{className:"bg-earth-900 text-earth-100 text-xs rounded-lg p-3 whitespace-pre-wrap break-words my-2",children:e.jsx("code",{children:s})})}const p=`<script src="${d}/v1/widget.js"
